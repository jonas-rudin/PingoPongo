    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                Text("1. Tournament Setup:").font(.title2).bold().padding()
                ...
                Text("2. Rounds:").font(.title2).bold().padding()
                ...
                Text("3. Match Rules:").font(.title2).bold().padding()
                ...
                Text("4. Tournament Progress:").font(.title2).bold().padding()
                ...
                Text("5. Finals:").font(.title2).bold().padding()
                ...
                Text("6. Final Match Rules:").font(.title2).bold().padding()
                Text("In the finals, matches can be played to 11 or 21 points, with the requirement of a two-point difference.")
                ...
                Spacer()
                Text("Enjoy your table tennis tournament, and may the best player win! If you have any questions or need assistance, please feel free to explore the app's various sections or reach out for support as needed. Good luck and have fun!")
